...
const Heading = () => {
  return (
    <div className="h-auto flex flex-col items-center justify-center gap-3 m-4">
      {" "}
      <div className="text-primary text-3xl font-medium" > VHTOP translates to "VIT HOSTEL on TOP"</div>
