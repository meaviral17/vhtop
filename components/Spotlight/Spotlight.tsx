      ...
      <div className="flex justify-items:center align-items:center center h-full  sm:ml-12 ml-3 ">
        <div className="w-full min-h-screen p-2">
          <div className="w-full min-h-screen ">
            <Button className="mt-4">Room Allotments</Button>
            <div className=" w-full h-full ">
              <div className="flex px-4  w-full h-full ">
                <span className="sm:mt-3 mt-1"><Image alt="ss" src={lightning} height={20} width={20}></Image></span>
            ...
            <Button className="mt-4">Mess</Button>
            <div className=" w-full h-full ">
              <div className="flex px-4  w-full h-full ">
              <span className="sm:mt-3 mt-1"><Image alt="ss" src={lightning} height={20} width={20}></Image></span>
                <span className="ml-2 text-wrap text-base sm:text-xl sm:m-3 m-1">
            ...
            <Button className="mt-4">Games</Button>
            <div className=" w-full h-full ">
              <div className="flex px-4  w-full h-full ">
              <span className="sm:mt-3 mt-1"><Image alt="ss" src={lightning} height={20} width={20}></Image></span>
                <span className="ml-2 text-wrap text-base sm:text-xl sm:m-3 m-1">
            ...
            <Button className="mt-4">Laundry</Button>
            <div className=" w-full h-full ">
              <div className="flex px-4  w-full h-full ">
              <span className="sm:mt-3 mt-1"><Image alt="ss" src={lightning} height={20} width={20}></Image></span>
                <span className="ml-2 text-wrap text-base sm:text-xl sm:m-3 m-1">
